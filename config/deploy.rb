...
set :application, "km63"

role :app, "km63next.adammiribyan.com"
role :web, "km63next.adammiribyan.com"
role :db,  "km63next.adammiribyan.com", :primary => true

set :scm, "git"
set :repository,  "git@github.com:adammiribyan/km63.git"
...
set :branch, "master"
set :deploy_to, "/home/#{user}/Volumes/#{application}"
...
before "deploy:finalize_update", "symlink:shared_config_files"
